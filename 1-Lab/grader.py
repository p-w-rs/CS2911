...
class TestStringMethods(unittest.TestCase):
    ...
    def test_str_bits(self):
        strs = [
            'MAyDCEnfmz', 'ipjPhHBdzO', 'RoOeFyrlnB', 'vwZirOThda',
            'RnvSUIcCxX', 'ykIykPHjGS', 'orIwLBnnvP', 'utymLcrtTz',
            'BeRkLIxqCK', 'JvobHwRJIu'
        ]
        bins = [
    ...
    def test_bytes_bits(self):
        bstrs = [
            b'yOlNlfOhPI', b'caSDYjCMVo', b'zeTsqTmkXn', b'BnnWYisOKr',
            b'yqXthKCshU', b'hMHvDyDnvQ', b'WmuUTDDgYY', b'eQgxeuzDkR',
            b'IyjgRNWsfz', b'pTWuTHlcic'
        ]
        bins = [
    ...
    def test_str_hex(self):
        strs = [
            'jzDoltpxag', 'tRlnXEUuco', 'oisSuNWLLL', 'zYzLsYjnOx',
            'ofJzDsFFtj', 'jXGnKvnZeu', 'bjaKyWmknT', 'NWxfZKXzrQ',
            'DnmasAUVtc', 'DCvVxhuUhO'
        ]
        hexs = [
            '0x6a7a446f6c7470786167', '0x74526c6e58455575636f',
            '0x6f697353754e574c4c4c', '0x7a597a4c73596a6e4f78',
            '0x6f664a7a44734646746a', '0x6a58476e4b766e5a6575',
            '0x626a614b79576d6b6e54', '0x4e5778665a4b587a7251',
            '0x446e6d61734155567463', '0x4443765678687555684f'
        ]
    ...
    def test_bytes_hex(self):
        bstrs = [
            b'GbraQXqViB', b'shABSzqTZZ', b'SEDMhYGZIR', b'ZjNqPkhkwW',
            b'ptYOJdxeui', b'crdJTSGSRY', b'pJWGoMeZkD', b'PhxTxdUmAu',
            b'DlyfOgOpgO', b'ImDQUWkoRd'
        ]
        hexs = [
            '0x47627261515871566942', '0x73684142537a71545a5a',
            '0x5345444d6859475a4952', '0x5a6a4e71506b686b7757',
            '0x7074594f4a6478657569', '0x6372644a545347535259',
            '0x704a57476f4d655a6b44', '0x506878547864556d4175',
            '0x446c79664f674f70674f', '0x496d445155576b6f5264'
        ]
    ...
    def test_bin_int(self):
        bins = [
            '-0b1101100000', '-0b100110011', '-0b111110001', '-0b110011011',
            '-0b1111111', '0b1001011110', '0b1001001100', '0b110',
            '0b1000011000', '0b1101110010'
        ]
    ...
    def test_bytes_int(self):
        bts = [
            b'\xff-', b'\xfd\x05', b'\xfc\xe3', b'\x02\x98', b'\xfe\xd0', b'b',
            b'\xfe}', b'\xfei', b'\xfc=', b'\x03J'
        ]
    ...
    def test_int_bytes(self):
        ...
        bts = [
            b'\x03\xae', b'\xfc\xcc', b'\x01\xfd', b'\xfd\xd3', b'\xfd\xc0',
            b'\x03\x8e', b'\xfe\xce', b'\xfd\xba', b'A', b'\xfd\xa9'
        ]
    ...
    def test_str_bytes(self):
        strs = [
            'OLWrUSFTFR', 'YmxPLMFAsQ', 'oyEbzThHxp', 'dbwFjBrXrk',
            'VhUMRttDKV', 'YWoQCYtAlE', 'iiclJTWpHw', 'SbfYiEQiih',
            'BoVxChxFov', 'LSDslXMPcW'
        ]
        bts = [
            b'OLWrUSFTFR', b'YmxPLMFAsQ', b'oyEbzThHxp', b'dbwFjBrXrk',
            b'VhUMRttDKV', b'YWoQCYtAlE', b'iiclJTWpHw', b'SbfYiEQiih',
            b'BoVxChxFov', b'LSDslXMPcW'
        ]
    ...
    def test_bytes_str(self):
        bts = [
            b'DgmaiOQUXQ', b'FLEYyxCBfS', b'MiPzKwCVzv', b'KjmilpJrAh',
            b'aCSzXgaORB', b'ROqRVQtJyd', b'skAKSgMgmF', b'SHMDanMFtY',
            b'gAoIowXHIO', b'PrKglHruuS'
        ]
        strs = [
            'DgmaiOQUXQ', 'FLEYyxCBfS', 'MiPzKwCVzv', 'KjmilpJrAh',
            'aCSzXgaORB', 'ROqRVQtJyd', 'skAKSgMgmF', 'SHMDanMFtY',
            'gAoIowXHIO', 'PrKglHruuS'
        ]
